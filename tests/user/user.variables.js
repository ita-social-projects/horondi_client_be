...
const INVALID_FIRST_NAME =
  '"firstName" with value "H" fails to match the required pattern: /^(?=.{2,30}$)[a-zA-Zа-яА-ЯІіїє]+(([\',. -][a-zA-Zа-яА-ЯІіїє])?[a-zA-Zа-яА-ЯІіїє]*)*$/u';
const INVALID_LAST_NAME =
  '"lastName" with value "O" fails to match the required pattern: /^(?=.{2,30}$)[a-zA-Zа-яА-ЯІіїє]+(([\',. -][a-zA-Zа-яА-ЯІіїє])?[a-zA-Zа-яА-ЯІіїє]*)*$/u';
