...
const googleUser = async (idToken, rememberMe, operations) => {
  const mutateGoogleUser = await operations.mutate({
    mutation: gql`
  ...
  return mutateGoogleUser.data.googleUser;
};
const facebookUser = async (idToken, rememberMe, operations) => {
  const mutateFacebookUser = await operations.mutate({
    mutation: gql`
      mutation ($idToken: String!, $rememberMe: Boolean) {
  ...
  return mutateFacebookUser.data.facebookUser;
};
